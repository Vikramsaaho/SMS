...
<body>
    ...
    <div id="admin" class="section-content">
        <h2>Admin Panel</h2>
        <p>Welcome, Administrator! Here you can manage student records, approvals, and system settings.</p>
    </div>

    <div id="about" class="section-content">
        <h2>About Us</h2>
        <p>We are a student management solution provider. Our mission is to simplify workforce
            management using modern technologies.</p>
    </div>

    <div id="contact" class="section-content">
        <h2>Contact Us</h2>
        <p>Email:telidu.com<br>Phone: +91 897547453<br>Address:where<br> India</p>
    </div>
